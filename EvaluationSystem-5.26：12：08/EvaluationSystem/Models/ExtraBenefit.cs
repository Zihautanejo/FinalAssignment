namespace EvaluationSystem.Models
{
    public class ExtraBenefit
    {
        ...
        public ExtraBenefit(string id,string theme,string type,string point,string time,int status,string note,string ProofFile,bool isvalid)
        {
