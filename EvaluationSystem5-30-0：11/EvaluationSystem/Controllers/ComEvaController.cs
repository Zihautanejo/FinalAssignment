...
namespace EvaluationSystem.Controllers
{
    ...
    public class ComEvaController : ControllerBase
    {
        ...
        public ActionResult<List<ComEvaluation>> QueryComEvaInClassOrderId(string grade, string major, int num, int state, string word)
        {
        ...
        public ActionResult<List<ComEvaluation>> QueryComEvaInClassOrderGradeUp(string grade, string major, int num, int state, string word)
        {
            CClass C = classService.GetCClassesByMajorGradeNum(major, grade, num);
            List<ComEvaluation> comList = comEvaService.QueryComEvaByClassId(C);
            var com = comEvaService.QueryComEvaByState(comList, state);
        ...
        public ActionResult<List<ComEvaluation>> QueryComEvaInClassOrderGradeDown(string grade, string major, int num, int state, string word)
        {
            CClass C = classService.GetCClassesByMajorGradeNum(major, grade, num);
            List<ComEvaluation> comList = comEvaService.QueryComEvaByClassId(C);
            var com = comEvaService.QueryComEvaByState(comList, state);
