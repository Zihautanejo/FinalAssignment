...
namespace EvaluationSystem.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [HttpGet("students")]
        public ActionResult<List<string>> GetStuInfo(string grade,string?classid,string major,string tutorid )
        {
            try
            {
                return userService.QueryStuInfo(grade, classid, major,tutorid);
            }
            catch (Exception ex)
            {
