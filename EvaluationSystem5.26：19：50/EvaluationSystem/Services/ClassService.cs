...
namespace EvaluationSystem.Services
{
    public class ClassService
    {
        ...
        //排序
        //按班号排序
        public List<CClass> SortByClassNum(string academy,string grade)
        {
            var query = dbContext.CClass
                .Where(c=>c.Academy==academy)
                .Where(c=>c.Grade==grade)
        ...
        //按平均综测成绩升序排序
        public List<CClass> SortByAvaPoint(string academy, string grade)
        {
        ...
        //按平均综测成绩降序排序
        public List<CClass> SortByAvaPointDescend(string? academy, string? grade)
        {
            if(academy!=null&&grade!=null)
            {
                var query = dbContext.CClass
        ...
        //按未提交人数降序排序
        public List<CClass> SortByNotSubNumDescend(string? academy, string? grade)
        {
            if (academy != null && grade != null)
            {
                var query = dbContext.CClass
