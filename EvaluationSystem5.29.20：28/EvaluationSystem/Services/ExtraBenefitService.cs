        ...
        public List<ExtraBenefit> GetBenefits(string ?type,string ?status,string? Btheme)
        {
                ...
                if(Btheme!=null)
                {
                    if(status!=null)
                    {
                        return dbContext.extraBenefits
                            .Where(b=>b.BenefitType==type&&b.BenefitTheme==Btheme&&b.BenefitStatus==status)
                            .ToList();
                    }
                    else
                    {
                        return dbContext.extraBenefits
                           .Where(b => b.BenefitType == type && b.BenefitTheme == Btheme)
                           .ToList();
                    }
                }
                else
            ...
            else
            {
                if (Btheme != null)
                {
                    ...
                    {
                        return dbContext.extraBenefits
                            .Where(b =>  b.BenefitTheme == Btheme && b.BenefitStatus == status)
                            .ToList();
                    }
                    else
                    {
                        return dbContext.extraBenefits
                           .Where(b => b.BenefitTheme == Btheme)
                           .ToList();
                    }
                }
                else
