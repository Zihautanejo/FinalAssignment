...
namespace EvaluationSystem.Controllers
{
    ...
    {
        private readonly DAO.EvaDbContext userDb;
        private readonly UserService userService;

        public UserController(DAO.EvaDbContext userDb) 
        {  
            this.userDb = userDb;
        ...
        [HttpGet("students/grade/major/tutorid")]
        public ActionResult<List<string>> GetStuInfo(string grade,string major,string tutorid )
        {
            try
            {
                return userService.QueryStuInfo(grade, major,tutorid);
            }
        ...
        public ActionResult<List<string>> GetStuInfo(int classid)
        {
            try
            {
                return userService.QueryStuInfoByClassId(classid);
            }
            catch (ArgumentException ex)
            {
                return BadRequest(ex.Message);
        ...
        //根据辅导员id查找学生
       /* [HttpGet("tutor/student")]
        public ActionResult<List<User>> GetStuByTutor(string id)
        {
            try
            {
                return userService.QueryStuByTutor(id);
            }
            catch(ArgumentException e)
            {
                return BadRequest(e.Message);
